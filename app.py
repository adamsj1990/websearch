...
# Search function adapted for Streamlit
def fetch_videos(performer_name):
    query = urllib.parse.quote(performer_name)
    url = f"https://www.eporner.com/api/v2/video/search/?query={query}&per_page=15&thumbsize=big&order=top-weekly&format=json"
